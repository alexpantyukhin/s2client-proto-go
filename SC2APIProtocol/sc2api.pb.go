...
func (Difficulty) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (PlayerType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (Alert) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (Result) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (ResponseReplayInfo_Error) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{37, 0} }
...
func (ResponseSaveMap_Error) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{41, 0} }
...
func (ActionChat_Channel) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{53, 0} }
...
type RequestJoinGame_Race struct {
	Race SC2APIProtocol1.Race `protobuf:"varint,1,opt,name=race,enum=SC2APIProtocol.Race,oneof"`
}
...
func (m *RequestJoinGame) GetRace() SC2APIProtocol1.Race {
	if x, ok := m.GetParticipation().(*RequestJoinGame_Race); ok {
		return x.Race
	}
	return SC2APIProtocol1.Race_NoRace
}
...
func _RequestJoinGame_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // participation.race
		...
		m.Participation = &RequestJoinGame_Race{SC2APIProtocol1.Race(x)}
		return true, err
...
func (*RequestObserverAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*ResponseObserverAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*RequestStep) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*ResponseStep) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*RequestData) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
type ResponseData struct {
	...
	Effects          []*SC2APIProtocol2.EffectData   `protobuf:"bytes,5,rep,name=effects" json:"effects,omitempty"`
	XXX_unrecognized []byte                          `json:"-"`
}
...
func (*ResponseData) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (m *ResponseData) GetEffects() []*SC2APIProtocol2.EffectData {
	if m != nil {
		return m.Effects
	}
	return nil
...
func (*RequestSaveReplay) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*ResponseSaveReplay) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*RequestReplayInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func (*PlayerInfoExtra) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }
...
func (*ResponseReplayInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }
...
func (*RequestAvailableMaps) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*ResponseAvailableMaps) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*RequestSaveMap) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*ResponseSaveMap) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (*RequestPing) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{42} }
...
func (*ResponsePing) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{43} }
...
func (*RequestDebug) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }
...
func (*ResponseDebug) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{45} }
...
type PlayerSetup struct {
	...
	Race             *SC2APIProtocol1.Race `protobuf:"varint,2,opt,name=race,enum=SC2APIProtocol.Race" json:"race,omitempty"`
...
func (*PlayerSetup) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{46} }
...
func (m *PlayerSetup) GetRace() SC2APIProtocol1.Race {
	if m != nil && m.Race != nil {
		return *m.Race
	}
	return SC2APIProtocol1.Race_NoRace
...
func (*SpatialCameraSetup) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{47} }
...
func (*InterfaceOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }
...
type PlayerInfo struct {
	...
	RaceRequested    *SC2APIProtocol1.Race `protobuf:"varint,3,opt,name=race_requested,json=raceRequested,enum=SC2APIProtocol.Race" json:"race_requested,omitempty"`
	RaceActual       *SC2APIProtocol1.Race `protobuf:"varint,4,opt,name=race_actual,json=raceActual,enum=SC2APIProtocol.Race" json:"race_actual,omitempty"`
...
func (*PlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }
...
func (m *PlayerInfo) GetRaceRequested() SC2APIProtocol1.Race {
...
func (m *PlayerInfo) GetRaceActual() SC2APIProtocol1.Race {
...
func (*PlayerCommon) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }
...
func (*Observation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }
...
func (*Action) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*ActionChat) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{53} }
...
func (*ActionError) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
func (*ObserverAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }
...
type ActionObserverCameraMove struct {
	WorldPos *SC2APIProtocol1.Point2D `protobuf:"bytes,1,opt,name=world_pos,json=worldPos" json:"world_pos,omitempty"`
...
func (*ActionObserverCameraMove) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57} }

func (m *ActionObserverCameraMove) GetWorldPos() *SC2APIProtocol1.Point2D {
	if m != nil {
		return m.WorldPos
	}
	return nil
...
func (*PlayerResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60} }
